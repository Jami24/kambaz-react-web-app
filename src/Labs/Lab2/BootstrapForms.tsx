...
export default function BootstrapForms() {
    return (
        <div id="wd-css-styling-forms">
            ...
            <FormLabel className="mt-3">Example textarea</FormLabel>
            <FormControl as="textarea" rows={3} />

            {/* Dropdown */}
            <div id="wd-css-styling-dropdowns" className="mt-3">
                <h3>Dropdowns</h3>
            ...
            {/* Responsive forms example 2 */}
            <div id="wd-css-responsive-forms-2" className="mt-3">
